...
const cutscenes: Record<string, { title: string; scenes: Scene[] }> = {
  "the-core-awakens": {
    ...
    scenes: [
      {
        id: 1,
        text: "In the beginning, there was only darkness... an endless void of potential.",
        visual: "🌌",
        duration: 5000,
      },
      {
        id: 2,
        text: "Then, a spark of energy ignited—The Core awakened.",
        visual: "✨",
        duration: 4500,
      },
      {
        id: 3,
        text: "Pure creation energy flowed outward, shaping reality itself.",
        visual: "💫",
        duration: 4500,
      },
      {
        id: 4,
        text: "The first world emerged from The Core's vision: Tropical Island.",
        visual: "🏝️",
        duration: 5000,
      },
      {
        id: 5,
        text: "Golden sands, swaying palms, and crystal waters—a paradise of peace.",
        visual: "🌴",
        duration: 4500,
      },
      {
        id: 6,
        text: "The Core smiled upon its creation. This would be the starting point for all Explorers.",
        visual: "🌅",
        duration: 5000,
      },
      {
        id: 7,
        text: "And so the universe began... waiting for those brave enough to explore its wonders.",
        visual: "🚀",
        duration: 5000,
      },
    ],
